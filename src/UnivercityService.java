...
public class UnivercityService {
   ...
   public void addStudent(Student student){
       try(Connection connection = ConnectionFactory.getConnection();
           PreparedStatement preparedStatement = connection.prepareStatement("insert into student(fname,lname) VALUES(?,?)")) {
    ...
    public void studentList(int teacherId){
        try (Connection connection = ConnectionFactory.getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement("SELECT student.ID,student.fname,student.lname,student_teacher.teacher_id from student_teacher join student on student.ID=student_teacher.student_id where student_teacher.teacher_id=?")){
    ...
    public void editStudent(String fname,String lname,int where){
        try(Connection connection = ConnectionFactory.getConnection();
            PreparedStatement preparedStatement = connection.prepareStatement("UPDATE student set fname=?,lname=? where ID=?")) {
